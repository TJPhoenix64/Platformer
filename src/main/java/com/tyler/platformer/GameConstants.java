...
public class GameConstants {
    ...
    static class Images {
        ...
        static final String SWORD_RIGHT = "/photos/pixelSwordRight.png";
        static final String SWORD_LEFT = "/photos/pixelSwordLeft.png";
        static final String HEART = "/photos/heart.png";
        ...
        static final String REFRESH_BUTTON = "/photos/refreshButton.png";
    ...
    static class Music {
        ...
        static final String BACKGROUND = "/music/background.wav";
        static final String PAUSE_BACKGROUND = "/music/pauseMenuBackground.wav";
        static final String HURT = "/music/hurt.wav";
        static final String DING = "/music/ding.wav";
        static final String FAIL = "/music/fail.wav";
    }
}
